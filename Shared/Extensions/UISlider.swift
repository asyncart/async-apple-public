...
private let defaultTrackColor: UIColor = .black
private let defaultMininumTrackTintColor: UIColor = .white
private let defaultMaximumTrackTintColor: UIColor = .red.withAlphaComponent(0.3)
private let defaultFocusScaleFactor: CGFloat = 1.05
private let defaultStepValue: Float = 4.0
...
public final class Slider: UIControl {
    ...
    @IBInspectable
    public var maximumTrackTintColor: UIColor? = defaultMaximumTrackTintColor {
        didSet {
    ...
    public var thumbViewCenterXConstraint: NSLayoutConstraint!
